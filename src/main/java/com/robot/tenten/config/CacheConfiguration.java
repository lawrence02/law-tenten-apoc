package com.robot.tenten.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.robot.tenten.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.robot.tenten.repository.UserRepository.USERS_BY_EMAIL_CACHE);
