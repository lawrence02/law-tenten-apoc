...
class ResourceResourceIT {
    ...
    public static Resource createEntity(EntityManager em) {
        Resource resource = new Resource().resourceType(DEFAULT_RESOURCE_TYPE).quantity(DEFAULT_QUANTITY);
        return resource;
    }
    ...
    public static Resource createUpdatedEntity(EntityManager em) {
        Resource resource = new Resource().resourceType(UPDATED_RESOURCE_TYPE).quantity(UPDATED_QUANTITY);
        return resource;
    }
    ...
    void createResource() throws Exception {
        ...
        assertThat(testResource.getQuantity()).isEqualTo(DEFAULT_QUANTITY);
    }
    ...
    void putExistingResource() throws Exception {
        ...
        assertThat(testResource.getQuantity()).isEqualTo(UPDATED_QUANTITY);
    }
    ...
    void partialUpdateResourceWithPatch() throws Exception {
        ...
        partialUpdatedResource.quantity(UPDATED_QUANTITY);
